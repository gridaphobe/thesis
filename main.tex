...
{}
%\input{nanomaly/haskellListings}
...
\section{\tool{NanoMaLy} User Study}
\label{sec:nanomaly:user-study}
% \includepdf[pages={-},pagecommand={},scale=0.65,frame,fitpaper]{user-study.pdf}
\subsection{Version A}
\fbox{\includegraphics[width=\textwidth,page=4]{nanomaly/user-study.pdf}}
\newpage
\fbox{\includegraphics[width=\linewidth,page=5]{nanomaly/user-study.pdf}}
\newpage
\fbox{\includegraphics[width=\linewidth,page=6]{nanomaly/user-study.pdf}}
\newpage
\subsection{Version B}
\fbox{\includegraphics[width=\linewidth,page=1]{nanomaly/user-study.pdf}}
\newpage
\fbox{\includegraphics[width=\linewidth,page=2]{nanomaly/user-study.pdf}}
\newpage
\fbox{\includegraphics[width=\linewidth,page=3]{nanomaly/user-study.pdf}}
