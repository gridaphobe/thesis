...
% \usepackage{bibentry}
% \nobibliography*
\usepackage[natbib=true,style=trad-abbrv,firstinits=true,isbn=false,maxbibnames=99,maxcitenames=1]{biblatex}
\makeatletter
...
\title{Data-Driven Techniques for Improving Type Error Diagnosis}
