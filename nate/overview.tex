...
\caption[(left) An ill-typed \ocaml program that should sum the elements of a
  list, with highlights indicating three possible blame assignments. (right) The
  error reported by \ocaml.]{
...
\paragraph{Solution: Localization via Supervised Classification}
%
...
\paragraph{Solution: Interaction Traces}
%
...
\paragraph{Solution: Bags-of-Abstracted-Terms}
%
...
\paragraph{Syntax and Type Features}
%
...
\paragraph{Contextual Features: Error Slices}
%
...
\paragraph{Solution: Rank Locations by Confidence}
%
