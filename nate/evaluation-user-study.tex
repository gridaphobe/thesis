...
and thus may not generalize to all developers. We chose the programs
manually, via a random selection and filtering of the programs
...
%
The number of submissions per program-tool was always at least 12 out of
a maximum of 15 or 16.
%
...
\input{nate/evaluation-user-study-graph}
...
|mulByDigit| were marked correct 5--25\% more often than \sherrloc
responses.
%
