...
An exciting opportunity for future work here would be using machine
...
models that can generate structured data, most notably images \ES{CITE}
and text \ES{CITE}, but also program terms
